...
def seed_data():
    ...
    try:
        ...
        # Seed Default Fee Rules using global classifications
        click.echo("Seeding default fee rules...")
        try:
            ...
            # Check if fee rules already exist
            ...
            if not existing_rules:
                ...
                for rule_data in default_rules:
                    ...
                    rules_created += 1
                click.echo(f"Created {rules_created} primary fee rules using 'Unclassified' classification.")
            else:
                click.echo("Default fee rules already exist, skipping.")
        except Exception as e:
            db.session.rollback()
            click.echo(f"Error seeding fee rules: {e}")
