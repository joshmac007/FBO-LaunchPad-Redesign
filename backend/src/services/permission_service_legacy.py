...
# Legacy role_permissions table has been removed
...
class PermissionService:
    ...
    def _get_legacy_role_permissions(cls, user: User) -> Dict[str, any]:
        """Legacy role-permission relationships have been removed.
        This method now returns empty for backward compatibility."""
        return {}
